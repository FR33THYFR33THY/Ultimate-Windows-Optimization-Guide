...
#trusted installer exploit by zoicware
...
# import reg file RunTrusted
$SecurityOff = "Regedit.exe /S `"$env:TEMP\SecurityOff.reg`""
Run-Trusted -command $SecurityOff
Start-Sleep 1
# stop smartscreen running
Stop-Process -Force -Name smartscreen -ErrorAction SilentlyContinue | Out-Null
# move smartscreen
$SmartScreen = "Move-Item -Path `"C:\Windows\System32\smartscreen.exe`" -Destination `"C:\Windows\smartscreen.exe`""
Run-Trusted -command $SmartScreen
Start-Sleep 1
...
Timeout /T 5 | Out-Null
# import reg file RunTrusted
$SecurityOn = "Regedit.exe /S `"$env:TEMP\SecurityOn.reg`""
Run-Trusted -command $SecurityOn
Start-Sleep 1
# move smartscreen
$SmartScreen = "Move-Item -Path `"C:\Windows\smartscreen.exe`" -Destination `"C:\Windows\System32\smartscreen.exe`""
Run-Trusted -command $SmartScreen
Start-Sleep 1
